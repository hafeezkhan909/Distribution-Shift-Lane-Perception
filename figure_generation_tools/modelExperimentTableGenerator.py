...
BASE_OUTPUT_DIR = "/home1/adoyle2025/Distribution-Shift-Lane-Perception/ModelExperimentFigures"
...
def main():
    ...
    for phase in PHASES:
        ...
        for n in SAMPLE_SIZES:
                    ...
                    for tgt in DATASETS:
                        ...
                        if phase == 1:
                            if src == tgt:
                                ...
                                filename = f"{n}Samples_{model}Model_{src}2{tgt}Data.json"
                        
                        elif phase == 2:
                            if src == tgt:
                                filename = f"P2{n}Samples_{model}Model_{src}Data.json"
                            else:
                                filename = f"P2{n}Samples_{model}Model_{src}2{tgt}Data.json"
                        # -------------------------------------------
            ...
            tex_filepath = os.path.join(phase_output_dir, f"Table_Phase{phase}_{n}Samples.tex")
            ...
            plt.title(f"Phase {phase} Distribution Shift: TPR (%) - {n} Samples\n(Blank cells indicate 'In Progress')", fontsize=14)
            ...
            fig_filepath = os.path.join(phase_output_dir, f"Figure_Phase{phase}_{n}Samples.png")
