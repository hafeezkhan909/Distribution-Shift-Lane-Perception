...
#SBATCH --job-name=P2100Samples_ImageNetModel_Curvelanes2CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/logs/Phase2_rerun/P2100Samples_ImageNetModel_Curvelanes2CULanesData.log
...
echo "Experiment: P2100Samples_ImageNetModel_Curvelanes2CULanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P2100Samples_ImageNetModel_Curvelanes2CULanesData.json"
