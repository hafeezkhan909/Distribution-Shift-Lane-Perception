...
#SBATCH --job-name=P21000Samples_CU_LaneModel_Curvelanes2CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/logs/Phase2_rerun/P21000Samples_CU_LaneModel_Curvelanes2CULanesData.log
...
echo "Experiment: P21000Samples_CU_LaneModel_Curvelanes2CULanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P21000Samples_CU_LaneModel_Curvelanes2CULanesData.json"
