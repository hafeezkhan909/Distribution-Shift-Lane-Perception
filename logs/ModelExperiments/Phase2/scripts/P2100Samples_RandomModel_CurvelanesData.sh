...
#SBATCH --job-name=P2100Samples_RandomModel_CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/logs/Phase2_rerun/P2100Samples_RandomModel_CurvelanesData.log
...
echo "Experiment: P2100Samples_RandomModel_CurvelanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P2100Samples_RandomModel_CurvelanesData.json"
