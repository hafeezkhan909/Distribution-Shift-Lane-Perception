...
#SBATCH --job-name=P210Samples_RandomModel_Curvelanes2CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/logs/Phase2_rerun/P210Samples_RandomModel_Curvelanes2CULanesData.log
...
echo "Experiment: P210Samples_RandomModel_Curvelanes2CULanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P210Samples_RandomModel_Curvelanes2CULanesData.json"
