#!/bin/bash
#SBATCH --job-name=d32gdd_K1000_E5
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d32gdd_K1000_Exp5.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d32gdd | K=1000 | Exp=5"
echo "----------------------------------------------------"
