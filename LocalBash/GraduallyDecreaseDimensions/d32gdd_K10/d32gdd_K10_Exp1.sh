#!/bin/bash
#SBATCH --job-name=d32gdd_K10_E1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d32gdd_K10_Exp1.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d32gdd | K=10 | Exp=1"
echo "----------------------------------------------------"
