#!/bin/bash
#SBATCH --job-name=d64gdd_K100_E11
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d64gdd_K100_Exp11.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d64gdd | K=100 | Exp=11"
echo "----------------------------------------------------"
