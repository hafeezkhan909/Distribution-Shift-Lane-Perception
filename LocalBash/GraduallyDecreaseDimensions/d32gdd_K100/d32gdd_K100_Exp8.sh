#!/bin/bash
#SBATCH --job-name=d32gdd_K100_E8
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d32gdd_K100_Exp8.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d32gdd | K=100 | Exp=8"
echo "----------------------------------------------------"
