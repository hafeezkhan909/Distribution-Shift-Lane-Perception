#!/bin/bash
#SBATCH --job-name=d64gdd_K1000_E8
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d64gdd_K1000_Exp8.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d64gdd | K=1000 | Exp=8"
echo "----------------------------------------------------"
