#!/bin/bash
#SBATCH --job-name=d64gdd_K10_E2
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d64gdd_K10_Exp2.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d64gdd | K=10 | Exp=2"
echo "----------------------------------------------------"
