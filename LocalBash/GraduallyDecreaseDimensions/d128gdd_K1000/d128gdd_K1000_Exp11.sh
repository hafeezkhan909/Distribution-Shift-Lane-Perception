#!/bin/bash
#SBATCH --job-name=d128gdd_K1000_E11
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128gdd_K1000_Exp11.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128gdd | K=1000 | Exp=11"
echo "----------------------------------------------------"
