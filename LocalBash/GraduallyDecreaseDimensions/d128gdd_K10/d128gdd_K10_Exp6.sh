#!/bin/bash
#SBATCH --job-name=d128gdd_K10_E6
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128gdd_K10_Exp6.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128gdd | K=10 | Exp=6"
echo "----------------------------------------------------"
