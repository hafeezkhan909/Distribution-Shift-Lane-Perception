#!/bin/bash
#SBATCH --job-name=d128gdd_K100_E3
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128gdd_K100_Exp3.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128gdd | K=100 | Exp=3"
echo "----------------------------------------------------"
...
python shift_concat_experiment.py \
    ...
    --src_samples 100 \
    --tgt_samples 100 \
    --ratio_src_samples 20 \
    --ratio_tgt_samples 80 \
    --num_runs 100 \
    --block_idx 4 \
    --seed_base 32 \
    --batch_size 512 \
