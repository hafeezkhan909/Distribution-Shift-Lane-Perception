#!/bin/bash
#SBATCH --job-name=d32_K100_E7
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d32_K100_Exp7.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d32 | K=100 | Exp=7"
echo "----------------------------------------------------"
