#!/bin/bash
#SBATCH --job-name=d128rel_K1000_E7
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128rel_K1000_Exp7.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128rel | K=1000 | Exp=7"
echo "----------------------------------------------------"
...
python shift_concat_experiment.py \
    ...
    --src_samples 1000 \
    --tgt_samples 1000 \
    --ratio_src_samples 600 \
    --ratio_tgt_samples 400 \
    --num_runs 100 \
    --block_idx 4 \
    --seed_base 32 \
    --batch_size 512 \
