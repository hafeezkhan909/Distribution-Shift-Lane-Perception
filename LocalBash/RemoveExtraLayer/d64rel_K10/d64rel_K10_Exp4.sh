#!/bin/bash
#SBATCH --job-name=d64rel_K10_E4
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d64rel_K10_Exp4.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d64rel | K=10 | Exp=4"
echo "----------------------------------------------------"
