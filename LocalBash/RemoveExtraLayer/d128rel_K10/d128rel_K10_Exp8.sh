#!/bin/bash
#SBATCH --job-name=d128rel_K10_E8
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128rel_K10_Exp8.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128rel | K=10 | Exp=8"
echo "----------------------------------------------------"
