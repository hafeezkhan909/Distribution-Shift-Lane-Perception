#!/bin/bash
#SBATCH --job-name=d32rel_K100_E9
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d32rel_K100_Exp9.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d32rel | K=100 | Exp=9"
echo "----------------------------------------------------"
