#!/bin/bash
#SBATCH --job-name=d32rel_K100_E1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d32rel_K100_Exp1.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d32rel | K=100 | Exp=1"
echo "----------------------------------------------------"
