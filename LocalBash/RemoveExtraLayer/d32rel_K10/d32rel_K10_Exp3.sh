#!/bin/bash
#SBATCH --job-name=d32rel_K10_E3
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d32rel_K10_Exp3.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d32rel | K=10 | Exp=3"
echo "----------------------------------------------------"
