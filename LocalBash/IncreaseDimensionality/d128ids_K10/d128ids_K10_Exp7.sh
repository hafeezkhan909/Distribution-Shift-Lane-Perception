#!/bin/bash
#SBATCH --job-name=d128ids_K10_E7
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128ids_K10_Exp7.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128ids | K=10 | Exp=7"
echo "----------------------------------------------------"
