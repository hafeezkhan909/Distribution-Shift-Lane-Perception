#!/bin/bash
#SBATCH --job-name=d128ids_K100_E3
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128ids_K100_Exp3.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128ids | K=100 | Exp=3"
echo "----------------------------------------------------"
