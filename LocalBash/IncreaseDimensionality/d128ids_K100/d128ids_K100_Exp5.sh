#!/bin/bash
#SBATCH --job-name=d128ids_K100_E5
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128ids_K100_Exp5.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128ids | K=100 | Exp=5"
echo "----------------------------------------------------"
...
python shift_concat_experiment.py \
    ...
    --src_samples 100 \
    --tgt_samples 100 \
    --ratio_src_samples 40 \
    --ratio_tgt_samples 60 \
    --num_runs 100 \
    --block_idx 4 \
    --seed_base 32 \
    --batch_size 512 \
