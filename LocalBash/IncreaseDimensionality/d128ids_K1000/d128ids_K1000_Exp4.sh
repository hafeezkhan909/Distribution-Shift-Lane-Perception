#!/bin/bash
#SBATCH --job-name=d128ids_K1000_E4
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128ids_K1000_Exp4.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128ids | K=1000 | Exp=4"
echo "----------------------------------------------------"
...
python shift_concat_experiment.py \
    ...
    --src_samples 1000 \
    --tgt_samples 1000 \
    --ratio_src_samples 300 \
    --ratio_tgt_samples 700 \
    --num_runs 100 \
    --block_idx 4 \
    --seed_base 32 \
    --batch_size 512 \
