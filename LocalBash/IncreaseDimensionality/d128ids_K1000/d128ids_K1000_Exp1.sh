#!/bin/bash
#SBATCH --job-name=d128ids_K1000_E1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d128ids_K1000_Exp1.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d128ids | K=1000 | Exp=1"
echo "----------------------------------------------------"
