#!/bin/bash
#SBATCH --job-name=d64ids_K10_E11
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d64ids_K10_Exp11.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d64ids | K=10 | Exp=11"
echo "----------------------------------------------------"
