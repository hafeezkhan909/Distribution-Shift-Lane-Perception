#!/bin/bash
#SBATCH --job-name=d64ids_K1000_E4
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/d64ids_K1000_Exp4.log
...
echo "----------------------------------------------------"
echo "Recovering Job: d64ids | K=1000 | Exp=4"
echo "----------------------------------------------------"
