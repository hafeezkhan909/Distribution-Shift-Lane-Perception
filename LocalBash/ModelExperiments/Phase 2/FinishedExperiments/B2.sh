...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/MMDAgg/P2CULaneTrain2CULaneTest100CU_Lane.log"
...
python model_experimentP2.py \
    ...
    --file_name "P2CULaneTrain2CULaneTest100CU_Lane.json" \
    --modelStr "CU_Lane"
