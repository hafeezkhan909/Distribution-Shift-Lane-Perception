...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/ModelExperiments/Phase 2/ImageNetModel/10/P2CurvelanesTrain2CurvelanesValid100ImageNet.log"
