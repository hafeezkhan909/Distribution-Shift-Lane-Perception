...
#SBATCH --job-name=P21000Samples_CU_LaneModel_CULanes2AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P21000Samples_CU_LaneModel_CULanes2AssistTaxiData.log
...
echo "Experiment: P21000Samples_CU_LaneModel_CULanes2AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "CU_Lane" \
    --file_name "P21000Samples_CU_LaneModel_CULanes2AssistTaxiData.json"
