...
#SBATCH --job-name=P2100Samples_CU_LaneModel_AssistTaxi2CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P2100Samples_CU_LaneModel_AssistTaxi2CULanesData.log
...
echo "Experiment: P2100Samples_CU_LaneModel_AssistTaxi2CULanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "CU_Lane" \
    --file_name "P2100Samples_CU_LaneModel_AssistTaxi2CULanesData.json"
