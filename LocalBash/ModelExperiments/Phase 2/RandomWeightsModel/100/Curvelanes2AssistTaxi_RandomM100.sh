...
#SBATCH --job-name=P2100Samples_RandomModel_Curvelanes2AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P2100Samples_RandomModel_Curvelanes2AssistTaxiData.log
...
echo "Experiment: P2100Samples_RandomModel_Curvelanes2AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "Random" \
    --file_name "P2100Samples_RandomModel_Curvelanes2AssistTaxiData.json"
