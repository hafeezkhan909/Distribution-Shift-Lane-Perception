...
#SBATCH --job-name=P2100Samples_RandomModel_AssistTaxi2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P2100Samples_RandomModel_AssistTaxi2CurvelanesData.log
...
echo "Experiment: P2100Samples_RandomModel_AssistTaxi2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "Random" \
    --file_name "P2100Samples_RandomModel_AssistTaxi2CurvelanesData.json"
