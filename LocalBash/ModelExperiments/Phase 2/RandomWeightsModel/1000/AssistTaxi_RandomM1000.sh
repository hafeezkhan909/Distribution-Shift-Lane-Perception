...
#SBATCH --job-name=P21000Samples_RandomModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P21000Samples_RandomModel_AssistTaxiData.log
...
echo "Experiment: P21000Samples_RandomModel_AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "Random" \
    --file_name "P21000Samples_RandomModel_AssistTaxiData.json"
