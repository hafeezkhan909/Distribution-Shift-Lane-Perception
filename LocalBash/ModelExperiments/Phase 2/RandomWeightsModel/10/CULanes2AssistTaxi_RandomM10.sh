...
#SBATCH --job-name=P210Samples_RandomModel_CULanes2AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P210Samples_RandomModel_CULanes2AssistTaxiData.log
...
echo "Experiment: P210Samples_RandomModel_CULanes2AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "Random" \
    --file_name "P210Samples_RandomModel_CULanes2AssistTaxiData.json"
