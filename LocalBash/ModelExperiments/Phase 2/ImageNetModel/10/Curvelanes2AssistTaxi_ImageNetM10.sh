...
#SBATCH --job-name=P210Samples_ImageNetModel_Curvelanes2AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P210Samples_ImageNetModel_Curvelanes2AssistTaxiData.log
...
echo "Experiment: P210Samples_ImageNetModel_Curvelanes2AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "ImageNet" \
    --file_name "P210Samples_ImageNetModel_Curvelanes2AssistTaxiData.json"
