...
#SBATCH --job-name=P210Samples_ImageNetModel_AssistTaxi2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P210Samples_ImageNetModel_AssistTaxi2CurvelanesData.log
...
echo "Experiment: P210Samples_ImageNetModel_AssistTaxi2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "ImageNet" \
    --file_name "P210Samples_ImageNetModel_AssistTaxi2CurvelanesData.json"
