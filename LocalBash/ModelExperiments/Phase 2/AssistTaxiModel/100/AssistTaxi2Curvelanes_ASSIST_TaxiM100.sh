...
#SBATCH --job-name=P2100Samples_ASSIST_TaxiModel_AssistTaxi2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P2100Samples_ASSIST_TaxiModel_AssistTaxi2CurvelanesData.log
...
echo "Experiment: P2100Samples_ASSIST_TaxiModel_AssistTaxi2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P2100Samples_ASSIST_TaxiModel_AssistTaxi2CurvelanesData.json"
