...
#SBATCH --job-name=P2100Samples_ASSIST_TaxiModel_CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P2100Samples_ASSIST_TaxiModel_CULanesData.log
...
echo "Experiment: P2100Samples_ASSIST_TaxiModel_CULanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P2100Samples_ASSIST_TaxiModel_CULanesData.json"
