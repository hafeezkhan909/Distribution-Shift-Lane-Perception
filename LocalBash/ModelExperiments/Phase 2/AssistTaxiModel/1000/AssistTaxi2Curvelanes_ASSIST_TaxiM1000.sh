...
#SBATCH --job-name=P21000Samples_ASSIST_TaxiModel_AssistTaxi2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P21000Samples_ASSIST_TaxiModel_AssistTaxi2CurvelanesData.log
...
echo "Experiment: P21000Samples_ASSIST_TaxiModel_AssistTaxi2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P21000Samples_ASSIST_TaxiModel_AssistTaxi2CurvelanesData.json"
