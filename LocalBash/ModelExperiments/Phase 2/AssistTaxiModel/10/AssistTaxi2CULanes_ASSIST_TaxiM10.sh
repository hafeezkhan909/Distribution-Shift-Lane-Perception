...
#SBATCH --job-name=P210Samples_ASSIST_TaxiModel_AssistTaxi2CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P210Samples_ASSIST_TaxiModel_AssistTaxi2CULanesData.log
...
echo "Experiment: P210Samples_ASSIST_TaxiModel_AssistTaxi2CULanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P210Samples_ASSIST_TaxiModel_AssistTaxi2CULanesData.json"
