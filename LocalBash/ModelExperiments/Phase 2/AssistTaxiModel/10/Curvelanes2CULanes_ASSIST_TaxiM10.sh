...
#SBATCH --job-name=P210Samples_ASSIST_TaxiModel_Curvelanes2CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P210Samples_ASSIST_TaxiModel_Curvelanes2CULanesData.log
...
echo "Experiment: P210Samples_ASSIST_TaxiModel_Curvelanes2CULanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P210Samples_ASSIST_TaxiModel_Curvelanes2CULanesData.json"
