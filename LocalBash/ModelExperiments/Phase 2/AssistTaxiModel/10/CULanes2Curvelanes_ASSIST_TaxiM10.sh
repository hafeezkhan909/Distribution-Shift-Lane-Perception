...
#SBATCH --job-name=P210Samples_ASSIST_TaxiModel_CULanes2CurvelanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P210Samples_ASSIST_TaxiModel_CULanes2CurvelanesData.log
...
echo "Experiment: P210Samples_ASSIST_TaxiModel_CULanes2CurvelanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P210Samples_ASSIST_TaxiModel_CULanes2CurvelanesData.json"
