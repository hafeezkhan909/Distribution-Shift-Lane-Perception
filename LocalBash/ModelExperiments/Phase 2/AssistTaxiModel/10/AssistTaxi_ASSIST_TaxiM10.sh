...
#SBATCH --job-name=P210Samples_ASSIST_TaxiModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P210Samples_ASSIST_TaxiModel_AssistTaxiData.log
...
echo "Experiment: P210Samples_ASSIST_TaxiModel_AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --file_name "P210Samples_ASSIST_TaxiModel_AssistTaxiData.json"
