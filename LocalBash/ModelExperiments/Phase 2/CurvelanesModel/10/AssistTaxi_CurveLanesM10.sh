...
#SBATCH --job-name=P210Samples_CurveLanesModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P210Samples_CurveLanesModel_AssistTaxiData.log
...
echo "Experiment: P210Samples_CurveLanesModel_AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "CurveLanes" \
    --file_name "P210Samples_CurveLanesModel_AssistTaxiData.json"
