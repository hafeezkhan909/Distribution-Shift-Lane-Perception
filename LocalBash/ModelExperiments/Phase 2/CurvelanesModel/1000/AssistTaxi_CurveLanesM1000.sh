...
#SBATCH --job-name=P21000Samples_CurveLanesModel_AssistTaxiData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P21000Samples_CurveLanesModel_AssistTaxiData.log
...
echo "Experiment: P21000Samples_CurveLanesModel_AssistTaxiData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "CurveLanes" \
    --file_name "P21000Samples_CurveLanesModel_AssistTaxiData.json"
