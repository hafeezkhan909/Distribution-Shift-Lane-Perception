...
#SBATCH --job-name=P21000Samples_CurveLanesModel_AssistTaxi2CULanesData
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=P21000Samples_CurveLanesModel_AssistTaxi2CULanesData.log
...
echo "Experiment: P21000Samples_CurveLanesModel_AssistTaxi2CULanesData"
echo "----------------------------------------------------"
...
python model_experimentP2.py \
    ...
    --batch_size 64 \
    --modelStr "CurveLanes" \
    --file_name "P21000Samples_CurveLanesModel_AssistTaxi2CULanesData.json"
