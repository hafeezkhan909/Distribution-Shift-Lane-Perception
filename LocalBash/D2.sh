...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/Energy/Distill/P2CULaneTrain2CULaneTest100DISTILL.log"
...
python model_experimentP2.py \
    ...
    --file_name "P2CULaneTrain2CULaneTest100DISTILL.json" \
    --modelStr "DISTILL"
