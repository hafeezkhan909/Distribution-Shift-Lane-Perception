...
#SBATCH --job-name=d128rel_K100_E6
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=d128rel_K100_Exp6.log
...
echo "Config: d128rel | Samples: 100"
echo "Experiment 6: Src=50% (50), Tgt=50% (50)"
echo "----------------------------------------------------"
