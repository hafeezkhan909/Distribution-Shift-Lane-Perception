...
#SBATCH --job-name=P2CurvelanesTrain2CULaneTest10000ImageNet
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output="/home1/adoyle2025/Distribution-Shift-Lane-Perception/LocalBash/ModelExperiments/Phase 2/ImageNetModel/10/P2CurvelanesTrain2CULaneTest10000ImageNetDim128.log"
...
python model_experimentP2.py \
    ...
    --file_name "P2CurvelanesTrain2CULaneTest10000ImageNet.json" \
    --modelStr "ImageNet"
