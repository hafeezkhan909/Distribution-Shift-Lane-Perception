...
#SBATCH --job-name=a32tf4
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=a32tf4.log
...
echo "Experiment 4: Src=30% (15 samples), Tgt=70% (35 samples)"
echo "----------------------------------------------------"
...
python shift_concat_experiment.py \
    ...
    --src_samples 1000 \
    --tgt_samples 50 \
    --ratio_src_samples 15 \
    --ratio_tgt_samples 35 \
    --num_runs 100 \
    --block_idx 4 \
    --seed_base 32 \
    --batch_size 4096 \
