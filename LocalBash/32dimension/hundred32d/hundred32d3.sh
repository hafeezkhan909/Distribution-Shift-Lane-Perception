...
#SBATCH --job-name=hundred32d3
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=hundred32d3.log
...
echo "Experiment 3: Src=20% (20 samples), Tgt=80% (80 samples)"
echo "----------------------------------------------------"
...
python shift_concat_experiment.py \
    ...
    --file_name "mixed_shift_experiment_32dimension_hundred.json"
